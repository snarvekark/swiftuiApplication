...
//Weekly weather report for all days of the week
...
//       }
    ...
    struct Weather: Codable {
        ...
        //Added By Sheetal 04/13 to get weather icon in weekly report
        let icon: String
...
//Detailed Weather Report for the Day
struct CurrentWeatherForecastResponse: Decodable {
    ...
    struct Main: Codable {
        ...
        //Added by Sheetal 04/14 to display Pressure
        let pressure: Double
